    ...
    newPostForm = (title, content) => (
        <form >
            ...
            <div className="form-group">
                ...
                <input onChange={this.handleChange("title")} value={title} type="text" className="form-control" />
            </div>
            <div className="form-group">
                <label className="text-muted">content</label>
                <input onChange={this.handleChange("content")} value={content} type="text" className="form-control" />
            </div>
            <button onClick={this.clickSubmit} className="btn btn-raised btn-primary">Create</button>
        </form>
    )

    render() {
        const { title, content, redirectToProfile, user, error, loading } = this.state
