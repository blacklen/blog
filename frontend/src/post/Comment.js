...
class Comment extends Component {
    ...
    addComment = e => {
        ...
        if (this.isValid()) {
            ...
            newComment(postId, token, userId, comment)
                .then(data => {
                ...
                <form onSubmit={this.addComment}>
                    <div className="form-group">
                        <input
                            ...
                            placeholder="My comment..." value={text}
                            type="text"
                                ...
                                <div>
                                    <Link to={`/user/${comment.postedBy._id}`}>
                                        <img
                                            ...
                                            weight="40px"
                                        />
                                        <h3 className="lead" style={{ display: "inline" }}>{comment.text}</h3>
                                    </Link>
                                    <br />
                                    <span className="font-italic mark" style={{ paddingRight: "120%" }}>
